		...
		if(e) {
			this.each(function() {
				...
				function f() {
					...
					c("span.plupload_upload_status", i).text(a("Arquivos %d/%d enviados").replace(/%d\/%d/, j.total.uploaded + "/" + j.files.length))
				}
				...
				function g() {
					...
					if(!j.files.length && j.features.dragdrop && j.settings.dragdrop) {
						c("#" + k + "_filelist").append('<li class="plupload_droptext">' + a("Arraste e solte os arquivos aqui.") + "</li>")
					}
				}
				...
				j.bind("Init", function(l, m) {
					...
					if(l.features.dragdrop && l.settings.dragdrop) {
						...
						c("#" + k + "_filelist").append('<li class="plupload_droptext">' + a("Arraste e solte o arquivo aqui.") + "</li>")
					}
