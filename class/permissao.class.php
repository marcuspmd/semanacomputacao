...
class permissao {
	...
	private $changed;
	//para update
	protected $idpermissao = null;
	protected $usuario_idusuario = null;
	protected $modulo_idmodulo = null;
	protected $createM = null;
	protected $readM = null;
	protected $updateM = null;
	protected $deleteM = null;
	protected $adicional = null;
	...
	public function save() {
		$retorno = $this -> db -> table(_TABLE_PERMISSAO_) -> data($this -> getStruct()) -> execute('insert');
	...
	public function update() {
		...
		$retorno = $this -> db -> table(_TABLE_PERMISSAO_) -> data($this -> getStruct()) -> query('idpermissao = ' . $this -> idpermissao) -> execute('update');

		return $retorno;
	}

	public function delete() {
		$retorno = $this -> db -> table(_TABLE_PERMISSAO_) -> query('idpermissao = ' . $this -> idpermissao) -> execute('delete');

		return $retorno;
	}

	public function select($id) {
		$retorno = $this -> db -> table(_TABLE_PERMISSAO_) -> query('idpermissao = ' . $id) -> execute('select');
