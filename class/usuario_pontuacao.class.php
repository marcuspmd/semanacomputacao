...
class usuario_pontuacao {
	...
	public function save() {
		$retorno = $this -> db -> table(_TABLE_USUARIO_PONTUACAO_) -> data($this -> getStruct()) -> execute('insert');
	...
	public function update() {
		...
		$retorno = $this -> db -> table(_TABLE_USUARIO_PONTUACAO_) -> data($this -> getStruct()) -> query('usuario_idusuario = ' . $this -> usuario_idusuario) -> execute('update');

		return $retorno;
	}

	public function delete() {
		$retorno = $this -> db -> table(_TABLE_USUARIO_PONTUACAO_) -> query('usuario_idusuario = ' . $this -> usuario_idusuario) -> execute('delete');

		return $retorno;
	}

	public function select($id) {
		$retorno = $this -> db -> table(_TABLE_USUARIO_PONTUACAO_) -> query('usuario_idusuario = ' . $id) -> execute('select');
