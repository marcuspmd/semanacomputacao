...
class aluno_eventos {
	...
	protected $evento_idevento = null;
	protected $dataEvento = null;
	protected $presenca = null;
	...
	public function save() {
		$retorno = $this -> db -> table(_TABLE_ALUNO_EVENTOS_) -> data($this -> getStruct()) -> execute('insert');
	...
	public function update() {
		...
		$retorno = $this -> db -> table(_TABLE_ALUNO_EVENTOS_) -> data($this -> getStruct()) -> query('usuario_idusuario = ' . $this -> usuario_idusuario) -> execute('update');

		return $retorno;
	}

	public function delete() {
		$retorno = $this -> db -> table(_TABLE_ALUNO_EVENTOS_) -> query('usuario_idusuario = ' . $this -> usuario_idusuario) -> execute('delete');

		return $retorno;
	}

	public function select($id) {
		$retorno = $this -> db -> table(_TABLE_ALUNO_EVENTOS_) -> query('usuario_idusuario = ' . $id) -> execute('select');
